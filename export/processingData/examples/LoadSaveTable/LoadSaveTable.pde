...
/**
 * -----
 * NOTE: Modified for use with ProcessingData library.
 * -----
 *
...
void loadData() {
  // MW - initialize ProcessingData instance to give access
  // to Data API functions.
...
void mousePressed() {
  ...
  // ProcessingData version:
  data.saveTable(table, "data/data.csv");
  // And reloading it
  loadData();
}
